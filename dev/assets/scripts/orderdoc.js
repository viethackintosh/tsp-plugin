...
import { UploadFiles } from './uxui/dragDropUpload.js';
...
const DDocument = function() {
      ...
      dd.uploadDocument = ({event}) => {
            ...
            if (target) {
                  ...
                  let uploadForm = masterModal.modal.body.querySelector('#docform');
                  let uploadToServer = masterModal.modal.footer.querySelector('.upload__toserver');
                  if (! uploadForm) masterModal.modal.body.append(uploadFormStandard);
